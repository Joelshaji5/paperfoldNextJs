...
function Priceing() {
    ...
    const [clickedListVal, setClickedVal] = useState([priceinglist] );
    ...
    <div>
      <section class="bg-white dark:bg-gray-900">
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          ...
          {
            clickedListVal.map((i ,index)=>{
              console.log(clickedListVal[priceinglist.WebDevelopment]
                )
              return(
                <>
                <h1>{clickedListVal[priceinglist.WebDevelopment.name]}</h1>
                <h1>{clickedListVal[index].WebDevelopment.price}</h1>
                </>
